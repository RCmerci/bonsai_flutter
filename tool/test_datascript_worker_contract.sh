...
require_text "$sdk_repository_lock" "SDK_PACKAGE_VERSION='0.1.0~dev.34'" \
...
framework_sdk="$sdk_packages/bonsai_flutter_ios_sdk/bonsai_flutter_ios_sdk.0.1.0~dev.34"
