...
Increment the iOS runtime recipe revision and publish new runtime and framework SDK development versions. The dependency source revisions and the runtime ABI revision remain unchanged.
